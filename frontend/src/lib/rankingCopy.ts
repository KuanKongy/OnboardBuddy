/**
 * The FAQ answer to "how is critical code ranked" (public /faq and the /help
 * tab both render it). It is the only place ranking is described in prose now:
 * every score in the product carries its own derivation from the API (see
 * `ScoreProvenance`). No em dashes: it renders on the public page.
 *
